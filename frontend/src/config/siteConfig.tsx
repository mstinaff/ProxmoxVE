...
export const navbarLinks = [
	{
		href: `https://github.com/mstinaff/${basePath}`,
		event: "Github",
	...
	{
		href: `https://github.com/mstinaff/${basePath}/blob/main/CHANGELOG.md`,
		event: "Change Log",
	...
	{
		href: `https://github.com/mstinaff/${basePath}/discussions`,
		event: "Discussions",
